...
func TestNewClientManagedIdentityNoNeedForCredentials(t *testing.T) {
	namespace := "internal"
	identityID := "1234"
	authType := esv1alpha1.AzureManagedIdentity
...
func TestGetAuthorizorForWorkloadIdentity(t *testing.T) {
	...
	authType := esv1alpha1.AzureWorkloadIdentity
	defaultProvider := &esv1alpha1.AzureKVProvider{
		VaultURL: &vaultURL,
		AuthType: &authType,
...
func TestAuth(t *testing.T) {
	defaultStore := esv1alpha1.SecretStore{
		ObjectMeta: metav1.ObjectMeta{
			Namespace: "default",
		},
	...
	authType := esv1alpha1.AzureServicePrincipal
